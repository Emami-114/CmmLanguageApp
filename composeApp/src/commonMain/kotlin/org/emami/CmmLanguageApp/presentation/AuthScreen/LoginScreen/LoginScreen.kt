...
import org.emami.CmmLanguageApp.openUrl
import org.emami.CmmLanguageApp.presentation.AuthScreen.registrationScreen.RegisterScreen
...
class LoginScreen : Screen {
    ...
    private fun LoginContent(
        uiState: LoginState, viewModel: LoginViewModel, navigator: Navigator
    ) {
        ...
        Column(modifier = Modifier.fillMaxSize().windowInsetsPadding(WindowInsets.safeDrawing)) {
            ...
            OutlinedTextField(value = uiState.passwordText,
                onValueChange = { viewModel.onEvent(LoginEvent.OnPasswordChanges(it)) },
                label = { Text("Password") },
                singleLine = true,
